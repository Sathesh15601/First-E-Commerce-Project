  ...
  return (
    <div className="border-t pt-14">
          ...
          return (
            ...
            >
              ...
              <input
                ...
                className="border rounded-lg max-w-10 sm:max-w-20 px-1 sm:px-2 py-1"
                type="number"
                min={1}
      ...
      <div className="flex justify-end my-20">
        <div className="q-full sm:w-[450px]">
          <CartTotal />
          <div className="w-full text-end">
            <button
              onClick={() => navigate("/place-order")}
              className="bg-black text-white rounded-lg text-sm my-8 px-8 py-3 "
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
